...
function creatTransformContext(root, options) {
    const context = {
        root,
...
function processExperssion(node) {
...
let compiler;
function registerRuntimeCopmpiler(_compiler) {
    compiler = _compiler;
}
...
function shoudUpdateComponent(preVNode, nextVnode) {
...
var runtimeDom = /*#__PURE__*/Object.freeze({
    ...
    proxyRefs: proxyRefs,
    ref: ref,
    registerRuntimeCopmpiler: registerRuntimeCopmpiler,
...
export { baseCompile, creatTextVNode, createApp, createVNode as createElementVNode, createRenderer, getCurrentInstance, h, inject, nextTick, provide, proxyRefs, ref, registerRuntimeCopmpiler, renderSlots, toDisplayString };
